...
const scenarioSets = [
  ...
  // ★ 1人目：リーズ
  {
    ...
    scenario: [
      { name: "リズ", text: "……起きた？ 思ったより早かったわね。" },
      { name: "リズ", text: "ここは、あなたが来るべき“境界”よ。" },
      {
        type: "choice",
        choices: [
      ...
      { name: "リズ", text: "焦らなくていい。まだ全部は話せないの。" },
      { name: "リズ", text: "でも覚えておいて。あなたはすでに選択を始めてる。" },
      { name: "リズ", text: "私？ 名前は……そうね、今は秘密にしておくわ。" },
      { name: "リズ", text: "最後まで見届けて。あなたの選択を。" }
    ]
  },
